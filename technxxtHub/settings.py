"""
Django settings for technxxtHub project.
...
ALLOWED_HOSTS = ['127.0.0.1', 'technxxt.onrender.com', 'web-production-9d0ce.up.railway.app', 'localhost']
